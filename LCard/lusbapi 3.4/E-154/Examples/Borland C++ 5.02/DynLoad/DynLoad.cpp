...
void main(void)
{
	...
	// попробуем обнаружить модуль E154 в первых WORD MAX_VIRTUAL_SLOTS_QUANTITY_LUSBAPI виртуальных слотах
	...
	// проверим, что это 'E154'
	if(strcmp(ModuleName, "E154")) AbortProgram(" The module is not 'E154'\n");
	else printf(" The module is 'E154'\n");
	...
	printf(" \n");
	printf(" Module E154 (S/N %s) is ready ... \n", ModuleDescription.Module.SerialNumber);
	printf("   Module Info:\n");
